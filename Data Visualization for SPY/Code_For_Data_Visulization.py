# ==============================================================================
# HMM REGIME ANALYSIS & VISUALIZATION PIPELINE
#
# OVERVIEW:
#   This module analyzes out-of-sample (OOS) HMM market regime classifications. 
#   It applies two-pass smoothing (moving mode and minimum duration enforcement) 
#   to filter high-frequency noise, plots shaded price charts and feature 
#   distributions, and computes regime transition matrices.
#
# SYSTEM & ENVIRONMENT REQUIREMENTS:
#   1. Python Version: Python 3.8 or higher
#   2. Core Libraries: pip install numpy pandas matplotlib seaborn yfinance
#   3. Active Internet Connection: Required to fetch SPY price data via yfinance 
#      for visual overlays.
#
# REQUIRED INPUT FILES (Must reside in the working directory):
#   1. 'hmm_oos_results.csv' : Generated by the HMM walk-forward backtest script. 
#                              Must contain date indices and columns for ['regime', 
#                              'log_return', 'volume_zscore', 'momentum', 
#                              'parkinson_vol', 'rsi', 'ma_cross'].
#
# HOW TO RUN:
#   - Command Line Exec : python Code_For_Data_Visulization.py
#   - Jupyter Notebook  : Run cell directly after downloading/generating input CSV.
#
# GENERATED OUTPUTS & ARTIFACTS:
#   1. 'spy_regimes.png'          : SPY price history with shaded regime spans.
#   2. 'feature_distributions.png': Histograms comparing feature profiles across regimes.
#   3. 'transition_matrix.png'    : Heatmap showing empirical transition probabilities.
#   4. 'features_over_time.png'   : Subplots of technical indicators overlaid with regimes.
# ==============================================================================
